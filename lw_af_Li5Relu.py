...
if __name__ == '__main__': 
    ...
    Exp_name = 'lw_af_Li5Relu_cluster' 
    ...
    get_AM4_data_lw(out_filelist, inp_filelist, condition='af', month_sel = None, day_sel = [1, 7]) 
    ...
    ind_train, ind_test = split_train_test_sample(output_array.shape[0], test_ratio=0.6, rng=rng) 
