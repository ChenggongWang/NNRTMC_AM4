...
if __name__ == '__main__': 
    ...
    Exp_name = 'sw_af_Li5Relu_cluster' 
    ...
    get_AM4_data_sw(out_filelist, inp_filelist, condition='af', month_sel = None, day_sel = [1, 7]) 
    ...
    # initialize model
    NNRTMC_solver = ResNNRTMC(device, nor_para, A_k, B_k, input_array.shape[1], model_state_dict)  
